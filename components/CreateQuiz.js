...
//   useEffect(() => { fetchTopics(); }, [selectedCourse]);
...
//     if (!selectedTopic || !questionText || !correctAnswer) return;
...
//   const [questionText, setQuestionText] = useState('');
//   const [options, setOptions] = useState(['', '', '', '']);
//   const [correctAnswer, setCorrectAnswer] = useState([]); // Now an array
//   const [hint, setHint] = useState('');
//   const [solution, setSolution] = useState('');
//   const [tips, setTips] = useState('');
//   const [formula, setFormula] = useState('');
...
//                   }`}
//                 >
//                   {correctAnswer.includes(option) ? 'Selected' : 'Select as Correct'}
//                 </button>
//               </div>
//             ))} */}
